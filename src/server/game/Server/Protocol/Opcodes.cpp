...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLL,                          0x1840, STATUS_NEVER    ); // 5.4.8 18414 (MoP structure)
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLLS_COMPLETE,                0x101B, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLL_WON,                      0x0A3A, STATUS_NEVER    ); // 5.4.8 18414 (MoP structure)
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_START_ROLL,                    0x0EAA, STATUS_NEVER    ); // 5.4.8 18414 (MoP structure)
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ALL_PASSED,                    0x0EBB, STATUS_NEVER    ); // 5.4.8 18414 (MoP structure)
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_COLLISION_HEIGHT, 0x1812, STATUS_UNHANDLED); // structure incomplete — do not broadcast (scale desync)
    ...
    DEFINE_OPCODE_HANDLER(SMSG_VOID_ITEM_SWAP_RESPONSE, 0x1EBF, STATUS_NEVER);
