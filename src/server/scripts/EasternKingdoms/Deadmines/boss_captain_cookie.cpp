...
class npc_captain_cookie_cauldron : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const OVERRIDE
        {
            return GetDeadminesAI<npc_captain_cookie_cauldronAI>(creature);
        }
};
...
class npc_captain_cookie_good_food : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const OVERRIDE
        {
            return GetDeadminesAI<npc_captain_cookie_good_foodAI>(creature);
        }
};
...
class npc_captain_cookie_bad_food : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* creature) const OVERRIDE
        {
            return GetDeadminesAI<npc_captain_cookie_bad_foodAI>(creature);
        }
};
